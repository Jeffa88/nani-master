...
Ovo je Python 3 implementacija Rubikove kocke 3X3
It contains/Sadržaj:

- A simple implementation of the cube / Jednostavno unišenje polja kocke
- A solver that follows a fixed algorithm / Rješenje sa fiksnim algoritmom
- An unintelligent solution sequence optimizer / Bez-inteligentna sekcija rješenja
- A decent set of test cases / Dovoljan broj tesnih slučajeva
