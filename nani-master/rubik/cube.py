...
# Rotacije za 90 stepeni u XY ravni. CW je u smjeru kazaljke na satu, CC je u suprotnom smjeru kazaljke na satu.
...
# Rotacije za 90 stepeni u XY ravni (oko y-ose kada se gleda okrenuto ka vama).
...
# Rotacije za 90 stepeni u YZ ravni (oko x-ose kada se gleda okrenuto ka vama).
